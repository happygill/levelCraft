...
import com.happysg.levelcraft.lock.LockDataLoader;
...
public class ModMessages {
    ...
    public static void register() {
        INSTANCE = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(LevelCraft.MODID, "messages"))
                .networkProtocolVersion(() -> "1.0")
                .clientAcceptedVersions(s -> true)
                .serverAcceptedVersions(s -> true)
                .simpleChannel();

        s2c(LockDataLoader.SyncPacket.class);
    ...
    private static <T extends SimplePacketBase> void make(Class<T> clazz, NetworkDirection dir) {
        INSTANCE.messageBuilder(clazz, id(), dir)
                ...
                .consumerNetworkThread(ModMessages::handler)
                .add();
    }
